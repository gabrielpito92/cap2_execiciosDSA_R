...
# stringr é um pacote para manipular strings em R
...
paste(nome, sobrenome) #une as 2 strs
cat(nome, sobrenome)

# Formatando a saída
sprintf('A %s é a nota %d', 'DSA', 10) #placeholder para str e num/decimal
...
# Usando stringr (CARREGANDO PACOTE!)
library(stringr)
